...
class SenderApp():
    def __init__(self,channel,role):
        ...
        self.button = tk.Button(self.root, text="Glisser et deposer un fichier ici ou cliquer pour selectionner", width=50, height=10, relief="solid", command=self.select_file)
    ...
    def send_file(self,file_path, server_host, server_port):
        ...
        try:
            ...
            metadata={"action": "upload_file", "data": {'file_name': file_name,"file_size":file_size,"file_hash":file_hash,"channel":self.channel}}
